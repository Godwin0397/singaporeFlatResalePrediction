...
def predict_price(year,town,flat_type,flr_area_sqm,flat_model,stry_start,stry_end,re_les_year,
    ...
    with open(r"C:/Users/Godveen/Guvi/capstoneProjects/Resale_Flat_Prices_Model_1.pkl","rb") as f:
...
if select == "Home":
    img= Image.open(r"C:/Users/Godveen/Guvi/capstoneProjects/images/singaporeFlatResale.jpg")
    st.image(img)
